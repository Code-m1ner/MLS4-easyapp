...
# Web and Mobile Shopping App. 

## Introduction

Welcome to my Fourth milestone project. This is a simple shopping web and mobile app that involves programming languages such as HTML5, CSS3, JavaScript and Python.
This app is called "Shoe Plug" and is suppose to demonstrate how all the above languages are used to showcase their excellence in delivering good product to the user from backend to frontend.
...
Advancement in technology has inspired most of us in our way of living be it in diet or dressing and now most people prefer being updated in dress styling mostly shoes and this
app gets even closer to them by providing enough categories of all gender's shoe design through their mobile gadgets.
